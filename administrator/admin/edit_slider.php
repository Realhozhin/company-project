        ...
        <section class="col-8 offset-2">
            <form action="slider/update.php" method="post" enctype="multipart/form-data">
                <section class="form-group">
                    ...
                    <input type="text" name="title" id="title" value="<?php echo $item['title']; ?>" class="form-control" style="border: 2px inset lightgray">
                </section>
                </br>
                <section class="form-group">
                    <label for="explanation">explanation</label>
                    <input type="text" name="explanation" id="explanation" value="<?php echo $item['explanation']; ?>"" class="form-control" style="border: 2px inset lightgray">
                </section>
                </br>
                <section class="form-group">
                    <label for="link">link</label>
                    <input type="url" name="link" id="link" value="<?php echo $item['link']; ?>" class="form-control" style="border: 2px inset lightgray">
                </section>
                </br>
                <section class="form-group">
                    ...
                    <img src="images/slider/<?php echo $item['image']?>" alt="" width="50px" height="50px">
                </section>
