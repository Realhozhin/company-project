...
<section class="container">
    <section class="row">
        <section class="col-8 offset-2">
            <form action="pacs/insert.php" method="post" enctype="multipart/form-data">
                ...
                <section class="form-group">
                    ...
                    <input type="url" name="address" id="address" placeholder="please enter address" class="form-control" style="border: 3px inset lightgray">
                </section>
                </br>
                <section class="form-group">
